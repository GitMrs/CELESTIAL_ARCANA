  ...
  return (
    ...
    >
      <div className="relative w-full max-w-[380px]  pt-10 flex flex-col items-center">
        ...
        <div
          ref={posterRef}
          className="relative w-full max-w-[380px] aspect-[9/16] overflow-hidden rounded-[1rem] border border-white/20 shadow-[0_0_80px_rgba(0,0,0,1)] flex flex-col items-center bg-black"
        >
          {/* 额外的边框线条和光影效果 */}
          ...
          <div className="relative z-10 w-full h-full p-2 flex flex-col items-center justify-between text-center">
            ...
            <div className="flex flex-col items-center flex-1 justify-center py-3">
              <div className="w-56 aspect-[2/3] relative rounded-2xl overflow-hidden shadow-[0_20px_50px_rgba(0,0,0,0.8)] border-2 border-yellow-500/30 mb-8 z-20">
                <img
              ...
              {/* <h3 className="text-lg font-serif text-yellow-50 font-black tracking-widest uppercase mb-1 relative z-20">
            ...
            <div className="w-full flex items-end justify-between border-t border-white/5 pt-2 pb-2">
